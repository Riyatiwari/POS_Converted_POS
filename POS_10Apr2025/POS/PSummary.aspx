<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="PSummary.aspx.vb" Inherits="PSummary" %>
                ...
                <div class="row">
                    ...
                    <center>
                          ...
                          <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-6 ">
                                 Till : &nbsp;
                                  <telerik:RadComboBox ID="radTill" runat="server" EnableCheckAllItemsCheckBox="True" CheckBoxes="True"
                                   ...
                                   <div class="col-lg-6 ">
                                      Customer : &nbsp;
                                        <telerik:RadComboBox ID="radCustomer" runat="server" >
                                        </telerik:RadComboBox>
                                     </div>
                ...
                <div style="float: right; margin-right: 20px;">
                    <table>
                        ...
                        <tr>
                            <td>
                                <u>
                                    <asp:LinkButton ID="lbtnsize" runat="server" OnClick="lbtnsize_Click" style="display:none;">Show Location</asp:LinkButton>
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color: #ffffff;">
                                            <a target="_blank" style="text-decoration: none;" href='<%#"Product_Master.aspx?product_id=" & Eval("product_id") %>'><%#Eval("Pname") %></a>
                                        </td>
                                        <td style="background-color: #ffffff;"><%#Eval("price") %></td>
                                        <td style="background-color: #ffffff;">
                                            <a target="_blank" style="text-decoration: none;" href='<%# string.Format("Product_Transaction_Detail.aspx?cID={0}&pid={1}&PR={2}&LID={3}&D={4}&s_date={5}&e_date={6}&type={7}&Dis={8}&other={9}&cusId={10}", Eval("cID"), Eval("product_id"), Eval("PR"), Eval("LID"), Eval("D"), Eval("s_date"), Eval("e_date"), Eval("type"), "0", "0", Eval("custID")) %>'>
                                                <%#Eval("Sale_qunt") %></a>
                                        </td>
                                         <td style="background-color: #ffffff;">
                                            <a target="_blank" style="text-decoration: none;" href='<%# string.Format("Product_Transaction_Detail.aspx?cID={0}&pid={1}&PR={2}&LID={3}&D={4}&s_date={5}&e_date={6}&type={7}&Dis={8}&other={9}&cusId={10}", Eval("cID"), Eval("product_id"), Eval("PR"), Eval("LID"), Eval("D"), Eval("s_date"), Eval("e_date"), Eval("type"), "0", "1", Eval("custID")) %>'>
                                                <%#Eval("sale_qunt_other") %></a>
                                        </td>
                                        <td style="background-color: #ffffff;"><%#Eval("return_qunt") %></td>
                                        <td style="background-color: #ffffff;"><%#Eval("Total_amt") %></td>
                                        <td style="background-color: #ffffff;">
                                            <a target="_blank" style="text-decoration: none;" href='<%# string.Format("Product_Transaction_Detail.aspx?cID={0}&pid={1}&PR={2}&LID={3}&D={4}&s_date={5}&e_date={6}&type={7}&Dis={8}&other={9}&cusId={10}", Eval("cID"), Eval("product_id"), Eval("PR"), Eval("LID"), Eval("D"), Eval("s_date"), Eval("e_date"), Eval("type"),"1", "0",Eval("custID")) %>'>
                                                <%#Eval("Discount") %> </a>
                                        </td>
