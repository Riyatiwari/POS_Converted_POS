<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Expense_List.aspx.vb" Inherits="Expense_List" %>
 ...
 <asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolderLink" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        function RowDblClick(sender, eventArgs) {
            ...
            var grid = $find("<%=rdExpense.ClientID %>");
            ...
            <div class="panel panel-yellow">
                ...
                <div class="panel-body pan">
                    <div class="form-body pal">
                        <div class="row">
                            <div class="col-lg-12 ">
                                <asp:LinkButton ID="lnkNew" runat="server" class="btn btn-outline btn-primary"><i class="fa fa-plus"></i>&nbsp;New Expense</asp:LinkButton>
                            </div>
                        </div>
                        <br />
                                            ...
                                            <asp:Repeater ID="rdExpense" runat="server" OnItemCommand="rdExpense_ItemCommand">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <asp:HiddenField ID="hfCategory_id" runat="server" Value='<%#Eval("Exp_id")%>' />
                                                            <asp:LinkButton ID="IbEdit" runat="server" CausesValidation="False" ToolTip="Edit"
                                                                CommandArgument='<%#Eval("Exp_id")%>' CommandName="Edit" OnClientClick="return true;"><i class="fa fa-edit fa-lg"></i></asp:LinkButton>
                                                            &nbsp;&nbsp;&nbsp;
                                        <asp:LinkButton ID="IbDelete" runat="server" CausesValidation="False" ToolTip="Delete"
                                            CommandArgument='<%#Eval("Exp_id")%>' CommandName="Delete" OnClientClick="return confirm('Are you sure you want to Delete this Record ?');"><i class="fa fa-trash fa-md"></i></asp:LinkButton>
