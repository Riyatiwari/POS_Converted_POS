<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Bank_Cash_Expense_List.aspx.vb" Inherits="Bank_Cash_Expense_List" %>
 ...
 <asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolderLink" runat="Server">
    <div class="page-header pull-left">
        <ol class="breadcrumb page-breadcrumb pull-left">
            ...
            <li class="active">Cash Expense</li>
        </ol>
    </div>
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-yellow">
            <div class="panel-heading">Cash Expense</div>
                                    ...
                                    <asp:Repeater ID="rdexpense" runat="server" OnItemCommand="rdexpense_ItemCommand">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="background-color: #ffffff;"><%#Eval("PerDay_amount") %></td>
                                                <td style="background-color: #ffffff;"><%#Eval("PerDayTotal_amount") %></td>
                                                <td style="background-color: #ffffff;"><%#Eval("From_Date") %></td>
                                                <td style="background-color: #ffffff;">&nbsp;&nbsp;
                                                     <asp:LinkButton ID="IbDelete" runat="server" CausesValidation="False" ToolTip="Delete"
                                                        CommandArgument='<%#Eval("Expense_Detail_id")%>' CommandName="Delete"
                            ...
                            <tfoot>
                                ...
                                <%--<telerik:RadGrid ID="rdexpense" AutoGenerateColumns="false" AllowPaging="True" AllowSorting="True" runat="server" ShowGroupPanel="False"
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" AllowMultiColumnSorting="true">
                                        <Columns>
                                            <telerik:GridBoundColumn ShowFilterIcon="false" CurrentFilterFunction="StartsWith" AutoPostBackOnFilter="true" HeaderText="Expense" UniqueName="Expense"
                                            ...
                                            <telerik:GridBoundColumn ShowFilterIcon="false" CurrentFilterFunction="StartsWith" AutoPostBackOnFilter="true" HeaderText="Per Day Amount"
                                                SortExpression="PerDay_amount" DataField="PerDay_amount" UniqueName="PerDay_amount">
                                            </telerik:GridBoundColumn>

                                            <telerik:GridBoundColumn ShowFilterIcon="false" CurrentFilterFunction="StartsWith" AutoPostBackOnFilter="true" HeaderText="Per Day Total Amount"
                                                SortExpression="PerDayTotal_amount" DataField="PerDayTotal_amount" UniqueName="PerDayTotal_amount">
                                            </telerik:GridBoundColumn>

                                            <telerik:GridBoundColumn ShowFilterIcon="false" CurrentFilterFunction="StartsWith" AutoPostBackOnFilter="true" HeaderText="From Date"
                                                SortExpression="From_Date" DataField="From_Date" UniqueName="From_Date">
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Action" UniqueName="TemplateColumn" AllowFiltering="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="IbDelete" runat="server" CausesValidation="False" ToolTip="Delete"
                                                        CommandArgument='<%#Eval("Expense_Detail_id")%>' CommandName="Delete" OnClientClick="return confirm('Are you sure you want to delete this record ?');"><i class="fa fa-minus-square-o fa-lg"></i></asp:LinkButton>
                                                </ItemTemplate>
