<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Till_Summary_New.aspx.vb" Inherits="Till_Summary_New" %>
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="PlaceHolderLink" runat="Server">
    <div class="page-header pull-left">
        <ol class="breadcrumb page-breadcrumb pull-left">
            ...
            <li class="active">POS Summary</li>
        </ol>
    </div>
        ...
        function Grid() {
            ...
            var table = $('#Psummary').DataTable({
                ...
                "drawCallback": function (settings) {
                    ...
                    //Grand Total 
                    var G_Total = document.getElementById('<%= hd_NetTotal.ClientID %>').value;
                    $(rows).eq(0).before(
                        '<tr class="group"><td colspan="7"> Grand Total </td>' +
                        '<td  colspan="12"> ' + symbol + ' ' + parseFloat(G_Total).toFixed(2) + '  </td> ' +
                        '</tr > '
                    );
 ...
 <asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel panel-yellow">
        <div class="panel-heading">POS Summary Report</div>
            ...
            <div class="form-body pal">
                ...
                <div class="row">
                    ...
                    <center>
                          ...
                          <br />
                            <div class="col-lg-6 ">
                                          Sales type : &nbsp;&nbsp;
                                        <telerik:RadComboBox ID="radsalesType" runat="server" >
                                             <Items>
                          ...
                          <div class="col-lg-6 ">
                                         &nbsp;&nbsp; Shift : &nbsp;&nbsp;
                                        <telerik:RadComboBox ID="radshifttype" runat="server">                                            
                                        </telerik:RadComboBox>                                      
                                     </div>
                ...
                <div style="float: right; margin-right: 20px;">
                    ...
                    <asp:LinkButton ID="LinkButton1" runat="server" class="btn btn-primary"
                        ToolTip="View Report" ValidationGroup="valid" OnClick="LinkButton1_Click1">View</asp:LinkButton>
                    <br />
                    <br />
                </div>

                <div>
                    <asp:HiddenField runat="server" ID="hd_NetTotal" />
                </div>
                                ...
                                <HeaderTemplate>
                                    <thead>
                                        <tr>
                                            ...
                                            <th>VAT12</th>
                                            <th>VAT20</th>
                 <th><asp:Label ID="lblDept1" runat="server" Text='<%# ViewState("Dept1") %>'></asp:Label></th>
                <th><asp:Label ID="lblDept2" runat="server" Text='<%# ViewState("Dept2") %>'></asp:Label></th>
                <th><asp:Label ID="lblDept3" runat="server" Text='<%# ViewState("Dept3") %>'></asp:Label></th>
                <th><asp:Label ID="lblDept4" runat="server" Text='<%# ViewState("Dept4") %>'></asp:Label></th>
                                          <%--  <th>Beverage</th>
                                            <th>Food</th>
                                            <th>Other</th>
                                            <th>Other_Dept</th>    --%>     
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td style="background-color: #ffffff;"><%#Eval("l_name")%></td>
                                        <td style="background-color: #ffffff;"><%#Eval("m_name")%></td>
                                        <td style="background-color: #ffffff;"><%#Eval("username")%></td>
                                        <td style="background-color: #ffffff;"><%# Eval("timespan", "{0:dd/MM/yyyy}") %></td>
                                        <td style="background-color: #ffffff;"><%#Eval("Qty")%></td>
                                        <td style="background-color: #ffffff;"><%#Eval("Gross")%></td>
                                        <td style="background-color: #ffffff;"><%#Eval("discount")%></td>
                                        <td style="background-color: #ffffff;"><%#Eval("Net")%></td>
                                        <td style="background-color: #ffffff;"><%#Eval("LastTransaction")%></td>
                                        <td style="background-color: #ffffff;"><%#Eval("surcharge")%></td>
                                        <td style="background-color: #ffffff;"><%#Eval("VAT")%></td>
                                        <td style="background-color: #ffffff;"><%#Eval("VAT0")%></td>
                                        <td style="background-color: #ffffff;"><%#Eval("VAT5")%></td>
                                        <td style="background-color: #ffffff;"><%#Eval("VAT12")%></td>
                                        <td style="background-color: #ffffff;"><%#Eval("VAT20")%></td>
                                        <td style="background-color: #ffffff;"><%#Eval(ViewState("Dept1").ToString().Replace(" ", "_"))%></td>
                                        <td style="background-color: #ffffff;"><%#Eval(ViewState("Dept2").ToString().Replace(" ", "_"))%></td>
                                        <td style="background-color: #ffffff;"><%#Eval(ViewState("Dept3").ToString().Replace(" ", "_"))%></td>
                                        <td style="background-color: #ffffff;"><%#Eval(ViewState("Dept4").ToString().Replace(" ", "_"))%></td>
                                                                  <%--      <td style="background-color: #ffffff;"><%#Eval("newdept")%></td>--%>
