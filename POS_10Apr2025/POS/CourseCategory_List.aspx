<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CourseCategory_List.aspx.vb" MasterPageFile="~/MasterPage.master" Inherits="CourseCategory_List" %>
    ...
    <div class="col-lg-12">
      <%--  <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">--%>
            ...
            <div class="panel panel-yellow">
                <div class="panel-heading">Course Category List</div>
                <div class="panel-body pan">
                    <div class="form-body pal">
                        <div class="row">
                            <div class="col-lg-12 ">
                                <asp:LinkButton ID="lnkNew" runat="server" OnClick="lnkNew_Click" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;New Course Category</asp:LinkButton>
                                &nbsp;&nbsp;
                            ...
                            <div class="col-lg-12 ">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="Lsummary" width="100%" cellspacing="0">
                                        <asp:Repeater ID="rdcourse" runat="server">
                                            <HeaderTemplate>
                                                <thead>
                                                    <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="background-color: #ffffff;">
                                                        ...
                                                        <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" ToolTip="Edit"
                                                            CommandArgument='<%#Eval("course_category_id")%>' CommandName="Edit" OnClientClick="return true;"><i class="fa fa-edit fa-lg"></i></asp:LinkButton>

                                                        &nbsp;&nbsp;&nbsp;
                                                        <asp:LinkButton ID="IbDelete" runat="server" CausesValidation="False" ToolTip="Delete"
                                                            CommandArgument='<%#Eval("course_category_id")%>' CommandName="Delete" OnClientClick="return confirm('Are you sure you want to Delete this Record ?');">
