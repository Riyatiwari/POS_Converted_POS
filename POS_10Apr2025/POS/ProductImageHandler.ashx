<%@ WebHandler Language="VB" Class="ProductImageHandler" %>
...
Public Class ProductImageHandler : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                If Val(context.Request.QueryString("Product_id").ToString()) > 0 Then

                    oColSqlPar.Add("@Product_id", context.Request.QueryString("Product_id"))
                    oColSqlPar.Add("@sorting_no", context.Request.QueryString("sono"))

                    imgdt = GetdataTableSp("WS_Get_Product_Image", oColSqlPar, "WS_Get_Product_Image", getconstr(dt))
