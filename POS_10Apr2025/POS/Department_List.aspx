<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Department_List.aspx.vb" Inherits="Department_List" %>
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <br />
    <%-- <div class="col-lg-12" id="divDepartment" runat="server">--%>
    <div class="col-lg-12">
            ...
            <div class="panel panel-yellow">
                ...
                <div class="panel-body pan">
                    <div class="form-body pal">
                        <div class="row">
                            <div class="col-lg-12 ">
                                <asp:LinkButton ID="lnkNew" runat="server" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;New Department</asp:LinkButton>
                            </div>
                        </div>
                        <br />
                        <div class="row" id="divDepartment" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="background-color: #ffffff;">&nbsp;&nbsp;
                                                        <asp:HiddenField ID="hfDepartment_id" runat="server" Value='<%#Eval("Department_id")%>' />
                                                        <asp:LinkButton ID="IbEdit" runat="server" CausesValidation="False" ToolTip="Edit"
                                                            CommandArgument='<%#Eval("Department_id")%>' CommandName="Edit" OnClientClick="return true;"><i class="fa fa-edit fa-lg"></i></asp:LinkButton>
                                                        &nbsp;&nbsp;&nbsp;
                                        <asp:LinkButton ID="IbDelete" runat="server" CausesValidation="False" ToolTip="Delete"
                                            CommandArgument='<%#Eval("Department_id")%>' CommandName="Delete" OnClientClick="return confirm('Are you sure you want to delete this record ?');">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <%--<telerik:RadGrid ID="rdDepartment" AutoGenerateColumns="false" AllowPaging="True" AllowSorting="True" runat="server" ShowGroupPanel="False"
                                        PageSize="50" AllowFilteringByColumn="true" SkinID="RadSkinManager1"
                                        PagerStyle-AlwaysVisible="true" Skin="MetroTouch">
                                        <ExportSettings FileName="Department" IgnorePaging="false" ExportOnlyData="true">
                                        </ExportSettings>
                                        ...
                                        <MasterTableView AutoGenerateColumns="False" AllowMultiColumnSorting="true">
                                            ...
                                            <Columns>
                                                <telerik:GridBoundColumn ShowFilterIcon="false" CurrentFilterFunction="StartsWith" AutoPostBackOnFilter="true" HeaderText="Department Name"
                                                    SortExpression="Name" DataField="Name">
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn ShowFilterIcon="false" CurrentFilterFunction="StartsWith" AutoPostBackOnFilter="true" HeaderText="Department Category"
                                                    SortExpression="department_category_name" DataField="department_category_name">
                                                </telerik:GridBoundColumn>
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Action" UniqueName="TemplateColumn" AllowFiltering="false">
                                                    <ItemTemplate>
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <asp:LinkButton ID="IbDelete" runat="server" CausesValidation="False" ToolTip="Delete"
                                            CommandArgument='<%#Eval("Department_id")%>' CommandName="Delete" OnClientClick="return confirm('Are you sure you want to delete this record ?');"><i class="fa fa-minus-square-o fa-lg"></i></asp:LinkButton>
                                                    </ItemTemplate>
