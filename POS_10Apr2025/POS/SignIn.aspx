...
<body style="background-image: url(images/bg/bg.jpg); opacity: 0.9;">
    ...
    <div class="page-form">
        <form action="SignIn.aspx" class="form" runat="server">
                            ...
                            <div id="divLogin" runat="server">
                                ...
                                <div class="form-group">
                                    <div class="input-icon right">
                                        ...
                                        <telerik:RadTextBox ID="txtUname" runat="server" Width="100%" BorderWidth="0" placeholder="Username/Email/TillCode/UserCode" TabIndex="1" CssClass="form-control">
                                        </telerik:RadTextBox>
                                ...
                                <div class="forget-password">
                                 <%--   <h4>Forgotten your Password?</h4>
                                    ...
                                    <p>click <a href='User_Access.aspx' class='btn-forgot-pwd'>here</a> to login with Email.</p>
