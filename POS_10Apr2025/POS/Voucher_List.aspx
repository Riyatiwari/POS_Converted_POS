<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Voucher_List.aspx.vb" MasterPageFile="~/MasterPage.master" Inherits="Voucher_List" %>
        ...
        <div class="panel panel-yellow">
            ...
            <div class="panel-body pan">
                <div class="form-body pal">
                    <div class="row">
                        <div class="col-lg-12 ">
                            <asp:LinkButton ID="lnkNew" runat="server" OnClick="lnkNew_Click" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;New Voucher</asp:LinkButton>
                        </div>
                    </div>
                    <br />
                                        ...
                                        <asp:Repeater ID="rdvoucher" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="background-color: #ffffff;"><%#Eval("Voucher_Type")%></td>
                                                    <td style="background-color: #ffffff;"><%#Eval("start_date", "{0:dd/M/yyyy}")%></td>
                                                    <td style="background-color: #ffffff;"><%#Eval("end_date", "{0:dd/M/yyyy}")%></td>
                                                    <%-- <td style="background-color: #ffffff;"><%#Eval("endless")%></td>--%>
                                                    <td style="background-color: #ffffff;">
                                                        <asp:HiddenField ID="hfdn_id" runat="server" Value='<%#Eval("voucher_id")%>' />
                                                        <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" ToolTip="Edit"
                                                            CommandArgument='<%#Eval("voucher_id")%>' CommandName="Edit" OnClientClick="return true;"><i class="fa fa-edit fa-lg"></i></asp:LinkButton>

                                                        &nbsp;&nbsp;&nbsp;<asp:LinkButton ID="IbDelete" runat="server" CausesValidation="False" ToolTip="Delete"
                                                            CommandArgument='<%#Eval("voucher_id")%>' CommandName="Delete" OnClientClick="return confirm('Are you sure you want to Delete this Record ?');">
