...
Public Class Controller_clsCategoryMainDemo
    Inherits BaseClass
...
#Region "Public Variables"
    ...
    Private _size_Detail_id As Integer
    Private _category_image As Byte()
    Private _dt As DataTable

    Private objclsCategory As clsCategoryMainDemo
#End Region
...
#Region "Public Property"
    ...
    Public Property size_Detail_id() As Integer
        Get
            Return _size_Detail_id
        End Get
        Set(ByVal value As Integer)
            _size_Detail_id = value
        End Set
    End Property

    Public Property category_image() As Byte()
        Get
...
#End Region
    ...
    Public Function Insert() As DataTable
        Try
            objclsCategory = New clsCategoryMainDemo()
            objclsCategory.Category_id = Category_id
            objclsCategory.key_map_id = key_map_id
            objclsCategory.cmp_id = cmp_id
            objclsCategory.name = name
            ...
            objclsCategory.category_image = category_image
    ...
    Public Function [SelectLoc]() As DataTable
        Dim dt As DataTable
        Try
            objclsCategory = New clsCategoryMainDemo()
            dt = objclsCategory.SelectLoc()
            Return dt
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    ...
    Public Function Insert_Size_Details() As DataTable
        Try
            objclsCategory = New clsCategoryMainDemo()
            objclsCategory.Category_id = Category_id
            objclsCategory.size_Detail_id = size_Detail_id
            objclsCategory.Location_Id = Location_Id
            objclsCategory.login_id = login_id
            objclsCategory.Ip_address = Ip_address
            ...
            Dim dt As New DataTable
            dt = objclsCategory.Insert_Size_Details()
            Return dt
    ...
    Public Function Update_Size_Details() As DataTable
        Try
            objclsCategory = New clsCategoryMainDemo()
            objclsCategory.Category_id = Category_id
            objclsCategory.size_Detail_id = size_Detail_id
            ...
            Dim dt As New DataTable
            dt = objclsCategory.Update_Size_Details()
            Return dt
    ...
    Public Function [SelectLoc_By_Id]() As DataTable
        Dim dt As DataTable
        Try
            objclsCategory = New clsCategoryMainDemo()
            objclsCategory.Category_id = Category_id
            dt = objclsCategory.SelectLoc_By_Id()
            Return dt
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
...
Public Class clsCategoryMainDemo
    Inherits BaseClass
    Dim oClsDal As ClsDataccess = New ClsDataccess()
...
#End Region
    ...
    Public Function Insert() As DataTable
        Try
            ...
            oColSqlparram.Add("@Tran_Type", "I")
            oColSqlparram.Add("@category_image ", category_image, SqlDbType.Image)
    ...
    Public Function [SelectLoc]() As DataTable
        ...
        Dim dtRole As DataTable = oClsDal.GetdataTableSp("Get_Loc", oColSqlparram)
    ...
    Public Function [SelectLoc_By_Id]() As DataTable
        ...
        Dim dtRole As DataTable = oClsDal.GetdataTableSp("Get_Loc_By_Cat_Id", oColSqlparram)
    ...
    Public Function Insert_Size_Details() As DataTable
        Try
            Dim oColSqlparram As ColSqlparram = New ColSqlparram()
            oColSqlparram.Add("@Category_id", Category_id, SqlDbType.Int)
            oColSqlparram.Add("@size_Detail_id", size_Detail_id, SqlDbType.Int)
            ...
            oColSqlparram.Add("@Tran_Type", "I")
            Dim dtlogin As DataTable = oClsDal.GetdataTableSp("P_M_Cat_Size_Details", oColSqlparram)
            Return dtlogin
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
