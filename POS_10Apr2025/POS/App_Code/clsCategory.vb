...
Public Class Controller_clsCategory
    Inherits BaseClass
...
#Region "Public Variables"
    ...
    Private _main_category_id As Integer
...
#End Region
    ...
    '    Try
    '        objclsCategory = New clsCategory()
    ...
    Public Function Insert() As DataTable
        Try
            ...
            objclsCategory.main_category_id = main_category_id
    ...
    Public Function Delete() As Boolean
        ...
        End Try
    End Function
    Public Function AssignTill() As Boolean
        Try
            objclsCategory = New clsCategory()
            If objclsCategory.AssignTill() Then
                Return True
            End If
            Return False
        Catch ex As Exception
    ...
    Public Sub SelectLocation(ByRef ddl As CheckBoxList, ByVal cmp_id As Integer)
        Try
            objclsCategory = New clsCategory()
            objclsCategory.cmp_id = cmp_id
            Dim dt As DataTable = objclsCategory.[Selectlocation]()
...
#End Region
    ...
    Public Function Insert() As DataTable
        Try
            ...
            oColSqlparram.Add("@main_category_id", main_category_id)
            oColSqlparram.Add("@Tran_Type", "I")
    ...
    Public Function AssignTill() As Boolean
        Try
            ...
            Dim dtlogin As DataTable = oClsDal.GetdataTableSp("AssignTill", oColSqlparram)
            Return True
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    ...
    Public Function [Select]() As DataTable
        ...
        oColSqlparram.Add("@Category_id", Category_id, SqlDbType.Int)
        oColSqlparram.Add("@cmp_id", cmp_id, SqlDbType.Int)
        Dim dtlogin As DataTable = oClsDal.GetdataTableSp("Get_M_Category", oColSqlparram)
    ...
    Public Function Update_sorting_no_dt() As DataTable
        ...
        End Try
    End Function
    Public Function [Selectlocation]() As DataTable
        Dim ds As New DataSet
