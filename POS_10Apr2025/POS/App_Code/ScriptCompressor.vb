        ...
        If Not String.IsNullOrEmpty(path) Then
            If context.Cache(path) Is Nothing Then
                ...
                For Each script As String In scripts
                    ...
                    If script.ToUpperInvariant().Contains("RESOURCE.AXD") Then
...
#Region "IHttpModule Members"
    ...
    Private Sub IHttpModule_Init(ByVal context As HttpApplication) Implements IHttpModule.Init
        AddHandler context.PostRequestHandlerExecute, New EventHandler(AddressOf context_BeginRequest)
    End Sub
...
#Region "Methods"
        ...
        Public Overrides Sub Write(ByVal buffer__1 As Byte(), ByVal offset As Integer, ByVal count As Integer)
            ...
            Dim regex As New Regex("<script\s*src=""((?=[^""]*(webresource.axd|scriptresource.axd))[^""]*)""\s*type=""text/javascript""[^>]*>[^<]*(?:</script>)?", RegexOptions.IgnoreCase)
