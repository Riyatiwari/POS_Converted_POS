<%@ WebHandler Language="VB" Class="Product_Group_Category_ImageHandler" %>
...
Public Class Product_Group_Category_ImageHandler : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                If Val(context.Request.QueryString("maincategory_id").ToString()) > 0 Then

                    oColSqlPar.Add("@maincategory_id", context.Request.QueryString("maincategory_id"))

                    imgdt = GetdataTableSp("WS_Get_MainCategory_Image", oColSqlPar, "WS_Get_MainCategory_Image", getconstr(dt))

                Else

                    oColSqlPar.Add("@category_id", context.Request.QueryString("category_id"))

                    imgdt = GetdataTableSp("WS_Get_category_Image", oColSqlPar, "WS_Get_category_Image", getconstr(dt))

                End If


                If imgdt.Rows.Count > 0 Then
                    context.Response.BinaryWrite(DirectCast(imgdt.Rows(0)("Pimage"), Byte()))
