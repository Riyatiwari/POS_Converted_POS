    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
        ...
        <div style="width: 100%;">
            <div style="float: right; width: 100%;">
                <div class="row" style="margin-bottom: 5px; height: 33px;display:none;">
                    <telerik:RadComboBox Visible="false" ID="ddLocation" runat="server" AutoPostBack="true" style="float:left" OnSelectedIndexChanged="ddLocation_SelectedIndexChanged" ></telerik:RadComboBox>
                      <asp:ImageButton Visible="false" ID="imgrefreshTableView" runat="server" Width="25px" Height="25px"  ToolTip="Refresh Table View"
                ...
                <div style="width: 100%; height: 600px; z-index: 100" id="containmentwrapper" runat="server"
                    ...
                    <asp:Repeater ID="rptDIV" runat="server">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdnpageX" runat="server" Value='<%# Eval("XLeft") - 150%>' />
                            <asp:HiddenField ID="hdnpageY" runat="server" Value='<%# Eval("YTop") - 75%>' />
                    ...
                    <asp:Repeater ID="rptOtherDIV" runat="server">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="OpageX" runat="server" Value='<%# Eval("OpageX") - 150%>' />
                            <asp:HiddenField ID="OpageY" runat="server" Value='<%# Eval("OpageY") - 75 %>' />
