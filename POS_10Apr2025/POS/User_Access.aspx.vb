...
Partial Class User_Access
    ...
    Protected Sub btnLogIn_Click(sender As Object, e As EventArgs) Handles btnLogIn.Click
        Try
            ...
            strcon.Open()
            Dim n As String = txtUname.Text.Trim()
            Dim p As String = txtUpassword.Text.Trim()
            Dim cmd As SqlCommand = New SqlCommand("Get_DB_Connection_UserDetails", strcon)
            cmd.CommandType = CommandType.StoredProcedure
            cmd.Parameters.AddWithValue("@Username", n.ToString)
            cmd.Parameters.AddWithValue("@Password", Encrypt(p))
            ...
            Session("UserEmail") = txtUname.Text.Trim()
            ...
            If dtLogin.Rows.Count > 0 Then
                ...
                Else
                    If Not dtLogin.Rows(0)("is_active") = 0 Then
                        ...
                        Session("product_type") = dtLogin.Rows(0)("ProductType")
                        Session("StoreUUID") = dtLogin.Rows(0)("store_uuid")
                        Session("store") = dtLogin.Rows(0)("C_Name")
                        Session("staff_code") = dtLogin.Rows(0)("staff_code")
                        Try
                            BOokingLogin()
                        Catch ex As Exception
        ...
        Catch ex As Exception
            ...
            LogHelper.Error("User_Access:btnLogIn_Click:" + ex.Message)
        End Try
    End Sub
    Protected Function BOokingLogin()
        Try
            Dim conn As DBConnection = New DBConnection()
            Dim que = "Select * from Operator Where OpNumber = '" + Session("staff_code") + "'"
        ...
        Catch ex As Exception
            LogHelper.Error("User_Access:BOokingLogin():" + ex.Message)
        End Try
