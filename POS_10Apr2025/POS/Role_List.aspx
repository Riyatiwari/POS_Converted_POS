<%@ Page Title="Role List" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Role_List.aspx.vb" Inherits="Role_List" %>
          ...
          <div class="panel panel-yellow">
            ...
            <div class="panel-body pan">
                <div class="form-body pal">
                    <div class="row">
                        <div class="col-lg-12">
                            <%--<button class="btn btn-primary" runat="server" id="addRole">
                                <i class="fa fa-plus"></i>
                                New Role
                            </button>--%>
                             <asp:LinkButton ID="lnkNew" runat="server" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;New Role</asp:LinkButton>
                        </div>
                    </div>
                    <div class="btn-group">
                    </div>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="background-color: #ffffff;">
                                                        ...
                                                        CommandArgument='<%#Eval("Role_ID")%>' CommandName="Edit" OnClientClick="return true;"><i class="fa fa-edit fa-lg"></i></asp:LinkButton>
                                                    &nbsp;&nbsp;&nbsp;
                                        <asp:LinkButton ID="IbDelete" runat="server" CausesValidation="False" ToolTip="Delete"
                                            CommandArgument='<%#Eval("Role_ID")%>' CommandName="Del" OnClientClick="return confirm('Are you sure you want to delete this record ?');"><i class="fa fa-trash"></i></asp:LinkButton>
