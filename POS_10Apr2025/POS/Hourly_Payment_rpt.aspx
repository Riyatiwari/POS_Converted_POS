<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Hourly_Payment_rpt.aspx.vb" Inherits="Hourly_Payment_rpt" %>
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="PlaceHolderLink" runat="Server">
    <div class="page-header pull-left">
        <ol class="breadcrumb page-breadcrumb pull-left">
            ...
            <li class="active">Hourly Payment Report</li>
        </ol>
    </div>
            ...
            <div class="form-body pal">
                ...
                <div class="row">
                    ...
                    <center>
                                  <div class="col-lg-6 ">
                                     Duration : &nbsp;&nbsp;
                                        <asp:DropDownList ID="radDuration" runat="server"  Width="40%"  AutoPostBack="true" OnSelectedIndexChanged="radDuration_SelectedIndexChanged" >
                               ...
                               <div id="divcustom" runat="server" visible="false" >
                                ...
                                <telerik:RadDatePicker  Width="40%"  ID="txtForDate" runat="server" DateInput-EmptyMessage="Date" MinDate="01/01/1000" MaxDate="01/01/3000" skin="MetroTouch" >
                                 ...
                                 <div class="col-lg-6 ">                                     
                                  To Date : &nbsp;
                                <telerik:RadDatePicker  Width="40%"  ID="txtToDate" runat="server" DateInput-EmptyMessage="Date" MinDate="01/01/1000" MaxDate="01/01/3000" skin="MetroTouch">
                                    <DateInput runat="server" DateFormat="dd/MM/yyyy" />
                                    <Calendar runat="server" FirstDayOfWeek="Monday" >
                                        <SpecialDays>
                                            <telerik:RadCalendarDay Repeatable="Today" ItemStyle-CssClass="rcToday">
