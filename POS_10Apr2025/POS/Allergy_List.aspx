<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="Allergy_List.aspx.vb" Inherits="Allergy_List" %>
 ...
 <asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolderLink" runat="Server">
    <div class="page-header pull-left">
        <ol class="breadcrumb page-breadcrumb pull-left">
            ...
            <li class="active">Allergy List</li>
        </ol>
    </div>
        ...
        <div class="panel panel-yellow">
            ...
            <div class="panel-body pan">
                <div class="form-body pal">
                    <div class="row">
                        <div class="col-lg-12 ">
                            <asp:LinkButton ID="lnkNew" runat="server" OnClick="lnkNew_Click" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;New Allergy</asp:LinkButton>
                        </div>
                    </div>
                    <br />
                        ...
                        <div class="col-lg-12 ">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="Lsummary" width="100%" cellspacing="0">
                                    <asp:Repeater ID="rdalrgy" runat="server">
                                        <HeaderTemplate>
                                            <thead>
                                                <tr>
                                                    <th>Name</th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="background-color: #ffffff;">
                                                    <asp:HiddenField ID="hfdn_id" runat="server" Value='<%#Eval("allergy_id")%>' />
                                                    <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" ToolTip="Edit"
                                                        CommandArgument='<%#Eval("allergy_id")%>' CommandName="Edit" OnClientClick="return true;"><i class="fa fa-edit fa-lg"></i></asp:LinkButton>

                                                    &nbsp;&nbsp;<asp:LinkButton ID="IbDelete" runat="server" CausesValidation="False" ToolTip="Delete"
                                                        CommandArgument='<%#Eval("allergy_id")%>' CommandName="Delete" OnClientClick="return confirm('Are you sure you want to Delete this Record ?');">
