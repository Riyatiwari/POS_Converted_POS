...
Partial Class Sales_Report
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                If Request.QueryString("Duration") IsNot Nothing Or Request.QueryString("fDate") IsNot Nothing Then
                    ...
                    If Request.QueryString("fDate").ToString = "" Then
                        txtFrom.SelectedDate = System.DateTime.Now
                        txtTo.SelectedDate = System.DateTime.Now
                    Else
                        txtFrom.SelectedDate = Convert.ToDateTime(Request.QueryString("fDate")).ToString()
                        txtTo.SelectedDate = Convert.ToDateTime(Request.QueryString("fDate")).ToString()
                    End If

                    If Request.QueryString("Duration").ToString = "" Then
                        radDuration.SelectedValue = "Custom"
                    Else
                        radDuration.SelectedValue = Request.QueryString("Duration").ToString
                    End If
    ...
    Protected Sub RoleCheck()
        Try
            ...
            oclsRole.Form_Name = "Sales Report"
            oclsRole.Select()
    ...
    Private Sub BindTable()
        Try
            ...
            Dim dt As DataTable = oClsDal.GetdataTableSp("WS_R_Sales", oColSqlparram)
    ...
    Protected Sub lnkview_Click(sender As Object, e As EventArgs)
        Try
            ...
            If (Session("type").ToString() = "Cash" Or Session("type").ToString() = "Card" Or Session("type").ToString() = "Integrated - Room Payment" Or
                Session("type").ToString() = "Integrated - Helpout" Or Session("type").ToString() = "Gift Card" Or Session("type").ToString() = "Deposit Sale" Or
                Session("type").ToString() = "Integrated - Elina" Or Session("type").ToString() = "Integrated - Add Pay" Or Session("type").ToString() = "Credit Account" Or
                 Session("type").ToString() = "Integrated - Positive" Or Session("type").ToString() = "Other Voucher" Or Session("type").ToString() = "Prepaid Package" Or
                 Session("type").ToString() = "Other Deposit" Or Session("type").ToString() = "Integrated - Kinetic" Or Session("type").ToString() = "Payby Link") Then
            ...
            If Session("type").ToString().Contains("Card") = True Or Session("type").ToString().Contains("Cash") = True Or Session("type").ToString().Contains("Deposit") = True Or
                Session("type").ToString().Contains("Integrated") = True Or Session("type").ToString().Contains("Other") = True Or
                Session("type").ToString().Contains("Credit") = True Or Session("type").ToString().Contains("Package") = True Then
                If (Session("type").ToString() = "Cash" Or Session("type").ToString() = "Card" Or Session("type").ToString() = "Integrated - Room Payment" Or
                Session("type").ToString() = "Integrated - Helpout" Or Session("type").ToString() = "Gift Card" Or Session("type").ToString() = "Deposit Sale" Or
                Session("type").ToString() = "Integrated - Elina" Or Session("type").ToString() = "Integrated - Add Pay" Or Session("type").ToString() = "Credit Account" Or
                 Session("type").ToString() = "Integrated - Positive" Or Session("type").ToString() = "Other Voucher" Or Session("type").ToString() = "Prepaid Package" Or
        ...
        Catch ex As Exception
            LogHelper.Error("Sales_Report:lnkview_Click:" + ex.Message)
        End Try
    End Sub
