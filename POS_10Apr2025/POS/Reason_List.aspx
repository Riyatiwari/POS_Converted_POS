<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Reason_List.aspx.vb" Inherits="Reason_List" %>
 ...
 <asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolderLink" runat="Server">
    <div class="page-header pull-left">
        <ol class="breadcrumb page-breadcrumb pull-left">
            ...
            <li class="active">Reason List</li>
        </ol>
    </div>
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-yellow">
            <div class="panel-heading">Reason List</div>
            <div class="panel-body pan">
                <div class="form-body pal">
                    <div class="row">
                        <div class="col-lg-12 ">
                            <asp:LinkButton ID="lnkNew" runat="server" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;New Reason</asp:LinkButton>
                        </div>
                    </div>
                    <br />
                    <div class="row" id="divPGroup" runat="server">
                        <div class="col-lg-12 ">
                                    ...
                                    <asp:Repeater ID="rdCategory" runat="server" OnItemCommand="rdCategory_ItemCommand">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="background-color: #ffffff;"><%#Eval("reason")%></td>
                                                <td style="background-color: #ffffff;"><%#Eval("is_active")%></td>
                                                <td style="background-color: #ffffff;">
                                                    <asp:HiddenField ID="hfCategory_id" runat="server" Value='<%#Eval("reason_id")%>' />
                                                    <asp:LinkButton ID="IbEdit" runat="server" CausesValidation="False" ToolTip="Edit"
                                                        CommandArgument='<%#Eval("reason_id")%>' CommandName="Edit" OnClientClick="return true;"><i class="fa fa-edit fa-lg"></i></asp:LinkButton>
                                                    &nbsp;&nbsp;&nbsp;
                                        <asp:LinkButton ID="IbDelete" runat="server" CausesValidation="False" ToolTip="Delete"
                                            CommandArgument='<%#Eval("reason_id")%>' CommandName="Delete" OnClientClick="return confirm('Are you sure you want to delete this record ?');">
                            ...
                            <tfoot>
                                ...
                                <%--<telerik:RadGrid ID="rdCategory" AutoGenerateColumns="false" AllowPaging="True" AllowSorting="True" runat="server" ShowGroupPanel="False"
                                    PageSize="50" AllowFilteringByColumn="true" SkinID="RadSkinManager1"
                                    PagerStyle-AlwaysVisible="true" Skin="MetroTouch">
                                    <ExportSettings FileName="Category" IgnorePaging="false" ExportOnlyData="true">
                                    </ExportSettings>
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" AllowMultiColumnSorting="true">
                                        <Columns>
                                            <telerik:GridBoundColumn ShowFilterIcon="false" CurrentFilterFunction="StartsWith" AutoPostBackOnFilter="true" HeaderText="Reason"
                                                SortExpression="reason" DataField="reason">
                                            ...
                                            <telerik:GridBoundColumn ShowFilterIcon="false" CurrentFilterFunction="StartsWith" AutoPostBackOnFilter="true" HeaderText="Active"
                                                SortExpression="is_active" DataField="is_active">
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Action" UniqueName="TemplateColumn" AllowFiltering="false">
                                                <ItemTemplate>
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <asp:LinkButton ID="IbDelete" runat="server" CausesValidation="False" ToolTip="Delete"
                                            CommandArgument='<%#Eval("reason_id")%>' CommandName="Delete" OnClientClick="return confirm('Are you sure you want to delete this record ?');"><i class="fa fa-minus-square-o fa-lg"></i></asp:LinkButton>
                                                </ItemTemplate>
