<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TableBookingWidget.aspx.vb"
    Inherits="BookingEasy_TableBookingWidget" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%@ Register Src="../UserControl/ucTableWidget.ascx" TagName="TableBooking" TagPrefix="uc1" %>
        ...
        <div id="main-content">
            <div class="row">
                <div class="form-horizontal">
                    <div class="col-md-4">
                        <uc1:TableBooking ID="TableBooking" runat="server" IsDropdownPostback="false" />
                    </div>
                </div>
            </div>
        </div>
