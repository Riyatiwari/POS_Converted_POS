<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PopupUpdateBookingTable.aspx.vb"
    Inherits="BookingEasy_PopupUpdateBookingTable" %>
...
<body>
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
        ...
        <asp:Panel ID="pnlChangeTable" runat="server" Visible="false" Style="min-height: 370px;">
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-title">
                            <h3>
                                <i class="fa fa-search"></i>Available Tables</h3>
                            <div class="box-tool">
                                <a href="#" data-action="collapse"><i class="fa fa-chevron-up"></i></a>
                            </div>
                        </div>
        ...
        <asp:Panel ID="pnlBtn" runat="server">
            <div class="row">
                <div class="col-md-12 controls" style="text-align: center; height: 35px;">
                    ...
                    <asp:Button ID="btnSaveChangeTable" runat="server" Text="Update Table" CssClass="btn btn-success"
                        Visible="false" ValidationGroup="popallottbl" Style="float: left;" />
                    <asp:Button ID="btnCancel" runat="server" Text="Cancel Booking" CssClass="btn btn-danger"
                        Style="float: right; margin-right: 5px;" OnClientClick="if ( ! UserDeleteConfirmation()) return false;" />&nbsp;&nbsp;
                    <asp:Button ID="btnChangeBooking" runat="server" Text="Change Booking" CssClass="btn btn-success"
                        Style="float: right; margin-right: 5px;" Visible="false" />&nbsp;&nbsp;
                    <asp:Button ID="btnChangeTable" runat="server" Text="Change Table" CssClass="btn btn-success"
