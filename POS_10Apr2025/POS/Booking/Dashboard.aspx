<%@ Page Title="Search Hotel" Language="VB" MasterPageFile="~/BookingEasy/Site.master"
    AutoEventWireup="false" CodeFile="Dashboard.aspx.vb" Inherits="BookingEasy_Dashbord" %>

<%@ Register Src="../UserControl/RoomBooking.ascx" TagName="RoomBooking" TagPrefix="uc1" %>
<%@ Register Src="../UserControl/TableBooking.ascx" TagName="TableBooking" TagPrefix="uc1" %>
<%@ Register Src="../UserControl/ucSearchBooking.ascx" TagName="SearchBooking" TagPrefix="uc1" %>
 <asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript" id="telerikClientEvents1">
//<![CDATA[

        function tableScheduler_TimeSlotClick(sender, args) {
            //Add JavaScript handler code here
            //alert(eventArgs.get_time());
            $("#" + '<%=hdnSelectedDate.ClientID %>').val(convert(args.get_time()));
            __doPostBack('ctl00$ContentPlaceHolder1$lnkLoadTableBooking', '');
        }
        function roomScheduler_TimeSlotClick(sender, args) {
            //Add JavaScript handler code here
            //alert(eventArgs.get_time());
            $("#" + '<%=hdnSelectedDateRoom.ClientID %>').val(convert(args.get_time()));
            __doPostBack('ctl00$ContentPlaceHolder1$lnkLoadRoomBooking', '');
        }
...
//]]>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function PrintPage1() {
            ...
            var printContent = document.getElementById('<%= gvRoomBooking.ClientID %>');
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%--<asp:UpdatePanel ID="UpdatePanel1" runat="server" EnableViewState="true">
        <ContentTemplate>--%>
    <asp:DataList ID="dlTabs" runat="server" RepeatColumns="10" RepeatDirection="Horizontal">
        <ItemTemplate>
            <div class="TabHeader" runat="server" id="divTabHeader">
                <a id="aTabName" runat="server">
                    <%# Eval("TabName") %>
                </a>
            </div>
        </ItemTemplate>
    </asp:DataList>
    <telerik:RadTabStrip ID="tabStrip1" runat="server" Skin="Silk" SelectedIndex="0"
        MultiPageID="multiPage1" Visible="false">
        <Tabs>
            <telerik:RadTab Text="Search Booking" Width="330">
            </telerik:RadTab>
            <telerik:RadTab Text="Hotel Booking" Width="330">
            </telerik:RadTab>
            <telerik:RadTab Text="Schedule Booking" Width="330">
            </telerik:RadTab>
        </Tabs>
    </telerik:RadTabStrip>
    <telerik:RadMultiPage ID="multiPage1" runat="server" SelectedIndex="0">
        <telerik:RadPageView runat="server" ID="page11">
            <br />
            <div class="row">
                <div class="col-md-4">
                    <div class="box">
                        <div class="box-title">
                            <h3>
                                <i class="fa fa-table"></i>Search</h3>
                            <div class="box-tool">
                                <a href="#" data-action="collapse"><i class="fa fa-chevron-up"></i></a>
                            </div>
                        </div>
                        <div class="box-content" style="height: 255px;">
                            <div class="form-horizontal">
                                <uc1:SearchBooking ID="SearchBooking1" runat="server" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <telerik:RadPageView runat="server" ID="page12">
            <br />
            <div class="row">
                <div class="col-md-12" id="divRoomBooking" runat="server">
                    <div class="box">
                        <div class="box-title">
                            <h3>
                        ...
                        <div class="box-content" style="height: auto;">
                            <div class="form-horizontal">
                                <uc1:RoomBooking ID="RoomBooking1" runat="server" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12" id="divRoomBookingCal" runat="server">
                    <div class="box">
                        <div class="box-title">
                            <h3>
                        ...
                        <div class="box-content">
                            <%--<div>
                                        <h5 style="font-weight: bold; text-align: center;">
                                            <asp:Label ID="lblAllBooking" runat="server" Text=" "></asp:Label></h5>
                                        <b>All Bookings of </b>&nbsp;
                                        <telerik:RadDropDownList ID="ddlStore" Skin="MetroTouch" runat="server" Width="250px"
                            ...
                            <div>
                                ...
                                &nbsp;&nbsp;&nbsp; <b>Schedule </b>&nbsp;
                                <telerik:RadDropDownList ID="ddlTypeRoom" Skin="MetroTouch" runat="server" Width="250px"
                                    DropDownHeight="200px" AutoPostBack="true">
                                </telerik:RadDropDownList>
                            </div>
                            <br />
                            <div>
                                <asp:Button ID="BTnobookings" runat="server" BackColor="White" BorderStyle="Solid"
                                    Text="No Booking" Width="200px" Enabled="false" />
                                <asp:Button ID="BTlessThanHalffull" runat="server" BackColor="Beige" BorderStyle="Solid"
                                    Text="Less 1/2 Full" Width="200px" Enabled="false" />
                            </div>
                            <br />
                            <div>
                                <asp:Button ID="BTlessThanHalffull0" runat="server" BackColor="Pink" BorderStyle="Solid"
                                    Text="1/2 Full" Width="200px" Enabled="false" />
                                <asp:Button ID="BTlessThanHalffull1" runat="server" BackColor="Red" BorderStyle="Solid"
                                    Text="Full" Width="200px" Enabled="false" />
                            </div>
                            <br />
                            <telerik:RadScheduler ID="HotelCalender" runat="server" DataKeyField="bookingref"
                                DataStartField="date" DataEndField="date" DataSubjectField="FullName" AdvancedForm-Enabled="false"
                                SelectedView="MonthView" Skin="Office2007" Height="50%" MonthView-UserSelectable="false"
                                FirstDayOfWeek="Sunday" LastDayOfWeek="Saturday" Width="100%" OnClientTimeSlotClick="roomScheduler_TimeSlotClick">
                                <DayView UserSelectable="false" />
                                <WeekView UserSelectable="false" />
                                <TimelineView UserSelectable="false" />
                                <MonthView ReadOnly="true" HeaderDateFormat="dd/MM/yyyy" />
                            </telerik:RadScheduler>
                            <br />
                        </div>
                    </div>
                </div>
                <%--<div class="col-md-6" id="divRoomBookingCalRoomWise" runat="server">
                            <div class="box">
                                <div class="box-title">
                                    <h3>
                                        <i class="fa fa-table"></i>
                                        <%= HotelTabName %>
                                        Calender(Room Wise)</h3>
                                    <div class="box-tool">
                                        <a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
                                    </div>
                                </div>
                                <div class="box-content">
                                    <div class="row col-md-12">
                                        ...
                                        <div class="col-md-9">
                                            <telerik:RadDropDownList ID="drpHotel" Skin="MetroTouch" runat="server" Width="250px"
                                                DropDownHeight="200px" AutoPostBack="true">
                                            </telerik:RadDropDownList>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row col-md-12">
                                        ...
                                        <div class="col-md-9">
                                            <telerik:RadDropDownList ID="drpRoomType" Skin="MetroTouch" runat="server" Width="250px"
                                                DropDownHeight="200px" AutoPostBack="true">
                                            </telerik:RadDropDownList>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row col-md-12">
                                        <div class="col-md-3">
                                            <h5 style="font-weight: bold; text-align: center;">
                                                <asp:Label ID="Label3" runat="server" Text=" "></asp:Label></h5>
                                            <b>Room </b>
                                        </div>
                                        <div class="col-md-9">
                                            <telerik:RadDropDownList ID="drpRoom" Skin="MetroTouch" runat="server" Width="250px"
                                                DropDownHeight="200px" AutoPostBack="true">
                                            </telerik:RadDropDownList>
                                        </div>
                                    </div>
                                    <br />
                                    <div>
                                        <asp:Button ID="btnRoomWhite" runat="server" BackColor="White" BorderStyle="Solid"
                                            Text="No Booking" Width="200px" Enabled="false" />
                                        <asp:Button ID="btnRoomReserved" runat="server" BackColor="Green" BorderStyle="Solid"
                                            Text="Booked" Width="200px" Enabled="false" />
                                    </div>
                                    <br />
                                    <telerik:RadScheduler ID="RoomCalender" runat="server" DataKeyField="bookingref"
                                        DataStartField="date" DataEndField="date" DataSubjectField="bookingref" AdvancedForm-Enabled="false"
                                        SelectedView="MonthView" Skin="Office2007" Height="50%" MonthView-UserSelectable="false"
                                        FirstDayOfWeek="Sunday" LastDayOfWeek="Saturday" Width="100%">
                                        <DayView UserSelectable="false" />
                                        <WeekView UserSelectable="false" />
                                        <TimelineView UserSelectable="false" />
                                        <MonthView ReadOnly="true" HeaderDateFormat="dd/MM/yyyy" />
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-title">
                            <h3>
                                <i class="fa fa-table"></i>Booking List</h3>
                            <div class="box-tool">
                                <a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
                            </div>
                        </div>
                        <div class="box-content">
                            <div style="margin-bottom: 10px;">
                                ...
                                <asp:Label ID="lblListDateRoom" runat="server"></asp:Label>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:LinkButton ID="imgbtn1" runat="server" AlternateText="Xlsx" Style="float: right;">
                                            <img alt="" src="Images/excel.png" height="30px" style="margin:4px;margin-top:-20px;" />
                                    </asp:LinkButton>
                                </div>
                            </div>
                            <telerik:RadGrid ID="gvRoomBooking" runat="server" Skin="Office2010Blue" AutoGenerateColumns="false">
                                ...
                                <MasterTableView>
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="RoomType" HeaderText="Room Type" />
                                        <telerik:GridBoundColumn DataField="RoomName" HeaderText="Room Name" />
                                        <telerik:GridBoundColumn DataField="BookingRef" HeaderText="Reference" />
                                        <telerik:GridBoundColumn DataField="arrivaldate" HeaderText="Arrival Date" DataFormatString="{0:dd/MM/yyyy}"/>
                                        <telerik:GridBoundColumn DataField="departuredate" HeaderText="Departure Date" DataFormatString="{0:dd/MM/yyyy}"/>
                                        ...
                                        <%--<telerik:GridTemplateColumn HeaderText="">
                                                            <ItemTemplate>
                                                                <a href='<%# "popTodaysArrival.aspx?bookingref="+ Eval("BookingRef") %>' runat="server"
                                                                    id="aCheckIn" class="check-in">Checkin</a>
                                                            </ItemTemplate>
                                                        </telerik:GridTemplateColumn>--%>
                                    </Columns>
                                </MasterTableView>
            ...
            <asp:LinkButton ID="lnkLoadRoomBooking" runat="server"></asp:LinkButton>
            <asp:HiddenField ID="hdnSelectedDateRoom" runat="server" Value="0" />
            <div class="row" id="divTodaysArrival" runat="server">
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-title">
                            <h3>
                                <i class="fa fa-table"></i>Today's Arrival</h3>
                            <div class="box-tool">
                                <a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
                            </div>
                        </div>
                        <div class="box-content">
                            <div style="margin-bottom: 10px;">
                                <b>Venue </b>&nbsp;
                                <telerik:RadDropDownList ID="ddlStoreTodaysArrival" Skin="MetroTouch" runat="server"
                                    Width="250px" DropDownHeight="200px" AutoPostBack="True">
                                </telerik:RadDropDownList>
                                &nbsp;&nbsp;&nbsp; <b>Schedule </b>&nbsp;
                                <telerik:RadDropDownList ID="ddlTypeTodaysArrival" Skin="MetroTouch" runat="server"
                                    Width="250px" DropDownHeight="200px" AutoPostBack="true">
                                </telerik:RadDropDownList>
                            </div>
                            <telerik:RadGrid ID="gvTodayArrival" runat="server" Skin="Office2010Blue" AutoGenerateColumns="false">
                                <MasterTableView>
                                    <Columns>
                                        <telerik:GridBoundColumn DataField="FullName" HeaderText="Full Name" />
                                        <telerik:GridBoundColumn DataField="RoomType" HeaderText="Room Type" />
                                        <telerik:GridBoundColumn DataField="RoomName" HeaderText="Room Name" />
                                        <telerik:GridBoundColumn DataField="BookingRef" HeaderText="Reference" />
                                        <telerik:GridBoundColumn DataField="no_of_booking" HeaderText="# Booking" />
                                        <telerik:GridBoundColumn DataField="checkedin" HeaderText="Checked In" />
                                        <telerik:GridBoundColumn DataField="comment" HeaderText="Comments" />
                                        <telerik:GridTemplateColumn HeaderText="">
                                            <ItemTemplate>
                                                <a href='<%# "popTodaysArrival.aspx?bookingref="+ Eval("BookingRef") %>' runat="server"
            ...
            <div class="row" id="divTodaysDeparture" runat="server">
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-title">
                            <h3>
                                <i class="fa fa-table"></i>Today's Departure</h3>
                            <div class="box-tool">
                                <a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
                            </div>
                        </div>
                        <div class="box-content">
                            <div style="margin-bottom: 10px;">
                                <b>Venue </b>&nbsp;
                                <telerik:RadDropDownList ID="ddlStoreTodaysDeparture" Skin="MetroTouch" runat="server"
                                    Width="250px" DropDownHeight="200px" AutoPostBack="True">
                                </telerik:RadDropDownList>
                                &nbsp;&nbsp;&nbsp; <b>Schedule </b>&nbsp;
                                <telerik:RadDropDownList ID="ddlTypeTodaysDeparture" Skin="MetroTouch" runat="server"
                                    Width="250px" DropDownHeight="200px" AutoPostBack="true">
                                </telerik:RadDropDownList>
                            </div>
                            <telerik:RadGrid ID="gvTodayDeparture" runat="server" Skin="Office2010Blue" AutoGenerateColumns="false">
                                <MasterTableView>
                                    <Columns>
                                        <telerik:GridBoundColumn DataField="FullName" HeaderText="Full Name" />
                                        <telerik:GridBoundColumn DataField="RoomType" HeaderText="Room Type" />
                                        ...
                                        <telerik:GridBoundColumn DataField="BookingRef" HeaderText="Reference" />
                                        <telerik:GridBoundColumn DataField="no_of_booking" HeaderText="# Booking" />
                                        <telerik:GridBoundColumn DataField="checkedin" HeaderText="Checked Out" />
                                        <telerik:GridBoundColumn DataField="comment" HeaderText="Comments" />
                                        <telerik:GridTemplateColumn HeaderText="">
                                            <ItemTemplate>
                                                <a href='<%# "popTodaysDeparture.aspx?bookingref="+ Eval("BookingRef") %>' runat="server"
                                                    id="aCheckOut" class="check-out">Checkout</a>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                    </Columns>
                                </MasterTableView>
        ...
        <telerik:RadPageView runat="server" ID="page13">
            <br />
            <%--<div class="row">
            ...
            <div class="row">
                <div class="col-md-12" id="divTableBooking" runat="server">
                    <div class="box">
                        ...
                        <div class="box-content" style="height: auto;">
                            <div class="form-horizontal">
                                <uc1:TableBooking ID="TableBooking" runat="server" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4" id="div1" runat="server">
                    ...
                    <%--<div class="box">
                        <div class="box-title">
                            <h3>
                                <i class="fa fa-table"></i>Open Tables for Schedule
                                <%= RestaurentTabName %></h3>
                            <div class="box-tool">
                                <a href="#" data-action="collapse"><i class="fa fa-chevron-up"></i></a>
                            </div>
                        ...
                        <div class="box-content" style="height: 255px;">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-lg-8 controls">
                                        <asp:Button ID="btnOpenTodayTable" runat="server" Width="200px" Text="Open Todays Schedule"
            ...
            <div class="row" id="divRestaurentCal" runat="server">
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-title">
                            <h3>
                                <i class="fa fa-table"></i>Booking Details
                                <%--<%= RestaurentTabName %>
                                Calendar--%></h3>
                            <div class="box-tool">
                                <a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
                        ...
                        <div class="box-content">
                            <div class="row">
                                <div class="col-md-12" id="div4" runat="server">
                                    <div id="divMessageBox5" runat="server" visible="false">
                                        <asp:Label ID="lbExistingCust5" runat="server" Text=""></asp:Label>
                                    </div>
                                </div>
                            </div>
                            <div>
                                    ...
                                    <div class="box-content">
                                        <div class="form-horizontal">
                                            ...
                                            <div id="diviFrameTbl" runat="server" style="width: 100%;">
                                                <iframe src="Tab_Table_Management.aspx" width="100%" height="750px" style="border-width: 0;">
                                                </iframe>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="box-content">
                                        <div class="form-horizontal">
                                            <div id="div5" runat="server" style="width: 100%;">
                                                <iframe src="WaitingList.aspx" width="100%" height="650px" scrolling="yes" style="border-width: 0;">
                                                </iframe>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <%--<br />
                                    <div>
                                        <asp:Button ID="Button1" runat="server" BackColor="White" BorderStyle="Solid" Text="No Booking"
                                            Width="200px" Enabled="false" />
                                        <asp:Button ID="Button2" runat="server" BackColor="Beige" BorderStyle="Solid" Text="Less 1/2 Full"
                                            Width="200px" Enabled="false" />
                                    </div>
                                    <br />
                                    <div>
                                        <asp:Button ID="Button3" runat="server" BackColor="Pink" BorderStyle="Solid" Text="1/2 Full"
                                            Width="200px" Enabled="false" />
                                        <asp:Button ID="Button4" runat="server" BackColor="Red" BorderStyle="Solid" Text="Full"
                                            Width="200px" Enabled="false" />
                                    </div>--%>
                            <%--<br />
                                    <telerik:RadScheduler ID="tableScheduler" runat="server" DataKeyField="BookingDate"
                                        DataStartField="BookingDate" DataEndField="BookingDate" DataSubjectField="BookingDate"
                                        AdvancedForm-Enabled="false" SelectedView="MonthView" Skin="Office2007" Height="570"
                                        MonthView-UserSelectable="true" ReadOnly="true" OnClientTimeSlotClick="tableScheduler_TimeSlotClick">
                                        <DayView UserSelectable="false" />
                                        <WeekView UserSelectable="false" />
                                        <TimelineView UserSelectable="false" />
                                        <MonthView ReadOnly="true" HeaderDateFormat="dd/MM/yyyy" />
                                    ...
                                    <telerik:RadGrid ID="gvTableBooking" runat="server" Skin="Office2010Blue" AutoGenerateColumns="false">
                                        <MasterTableView>
                                            <Columns>
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Change Table">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="Center" />
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkpopup" runat="server" EnableViewState="true">
                                                            <a href='<%# "PopupEditBookingAllottedTable.aspx?bookingref=" + Eval("bookingref").ToString() %>'
                                                                id="aUpdateBooking" runat="server" class="edit-bookingAlloatedTables">Update Booking</a></asp:LinkButton>
                                                    </ItemTemplate>
                                                </telerik:GridTemplateColumn>
                                            </Columns>
                                        </MasterTableView>
