<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PageNotFound.aspx.vb" Inherits="BookingEasy_PageNotFound" %>
...
<body class="error-page">
    ...
    <div class="error-wrapper">
        <h4>
            Page Not Found<span>404</span></h4>
        <p>
            Oops! Sorry, that page couldn't be found.<br />
            Is there a typo in the url? Or try the search bar below.</p>
        <br />
        <hr />
        <%--<p class="clearfix">
