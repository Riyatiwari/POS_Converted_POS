<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PopupChangeTable.aspx.vb"
    Inherits="BookingEasy_PopupChangeTable" %>
...
<body>
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
        <asp:Panel ID="pnlChangeTable" runat="server" Visible="True" Style="min-height: 370px;">
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-title">
            ...
            <div class="row">
                <div class="col-md-12 controls" style="text-align: center; height: 35px;">
                    <asp:Button ID="btnSaveChangeTable" runat="server" Text="Update Table" CssClass="btn btn-success"
                        Visible="True" ValidationGroup="popallottbl" Style="float: left;" />
                </div>
            </div>
        </asp:Panel>
