<%@ Page Title="" Language="VB" AutoEventWireup="false" CodeFile="Booking_table_manage.aspx.vb"
    Inherits="BookingEasy_Booking_table_manage" EnableEventValidation="false" %>
...
<body bgcolor="White">
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
        ...
        <div style="width: 100%;">
            <div style="float: right; width: 85.8%;">
                <div class="row" style="margin-bottom: 5px;">
                    <telerik:RadAjaxPanel ID="RadAjaxPanel3" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
                        <asp:ImageButton ID="imgrefreshTableView" runat="server" Width="25px" Height="25px"
                            Style="padding: 5px; float: right;" ToolTip="Refresh Table View" OnClientClick="window.location.reload();"
                    ...
                    <asp:LinkButton ID="lnkDashboard" CssClass="bodyfont btn-successBlue btnflat" runat="server"
                        PostBackUrl="~/Booking/Dashboard.aspx">Go to Dashboard
                    </asp:LinkButton>
            ...
            <div style="float: left; width: 14%; height: 600px;">
        ...
        <telerik:RadWindow runat="server" ID="rwInfo" Modal="true" Width="400px" Height="550px"
            ...
            <ContentTemplate>
                <telerik:RadAjaxPanel ID="RadAjaxPanel4" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
                    ...
                    <div style="width: 100%">
                        <telerik:RadButton ID="lnkCloseWindow" Style="float: right; height: 26px;" AutoPostBack="true"
