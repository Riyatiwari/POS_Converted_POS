...
Partial Class Tab_Table_Management
    ...
    Protected Sub Set_BackgroundColor()
        Try
            ...
            Dim allStores As String = "select color from BookingSettings where BookingSettingsid =  " + Val(Session("drpTableStoreId")).ToString() + ""
