<%@ Page Title="Booking Detail" Language="VB" MasterPageFile="~/BookingEasy/Site.master"
    AutoEventWireup="false" CodeFile="BookingDetail.aspx.vb" Inherits="BookingEasy_BookingDetail" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="page-title">
                <div>
                    <h1>
                        <i class="fa fa-cutlery"></i>Booking Detail
                    </h1>
                </div>
            </div>
            <div class="row">
                            ...
                            <div id="divSearchResult" runat="server" class="col-lg-12 controls" style="padding-top: 10px;"
                                ...
                                <telerik:RadGrid ID="gvSearchClient" runat="server" AutoGenerateColumns="False" AllowPaging="true"
                                    ...
                                    <MasterTableView DataKeyNames="accountid">
                                        <Columns>
                                            <%--<telerik:GridButtonColumn ButtonType="ImageButton" UniqueName="btnSelectClient" CommandName="SelectClient"
                                                Text="Select" HeaderText="" HeaderStyle-Width="100px">
                                            ...
                                            <%--<telerik:GridBoundColumn DataField="phonework" HeaderText="Work Phone" />
                                                <telerik:GridBoundColumn DataField="accountid" HeaderText="Accountid" />
                                                <telerik:GridBoundColumn DataField="addressid" HeaderText="Addressid" Visible="False" />
                                                <telerik:GridBoundColumn DataField="pcode" HeaderText="Post Code" Visible="False" />
                                                <telerik:GridBoundColumn DataField="street_1" HeaderText="Street 1" Visible="False" />
                                                <telerik:GridBoundColumn DataField="Street_2" HeaderText="Street 2" Visible="False" />
                                                <telerik:GridBoundColumn DataField="Street_3" HeaderText="Street 3" Visible="False" />
                            ...
                            <div class="form-horizontal">
                                ...
                                <%--<div class="form-group">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-xs-3 col-lg-2 control-label">
                                                Total Price:</label>
                                            <div class="col-sm-9 col-lg-10 control-label" style="text-align: left">
                                                <b>
                                                    <asp:Label ID="lblRoomBookingTotal" runat="server" Text="0"></asp:Label>
                                                    +
                                                    <asp:Label ID="lblServiceTotal" runat="server" Text="0"></asp:Label>
                                                    =
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 col-lg-4 controls" style="text-align: center;">
                                        <asp:Button ID="btnConfitmBooking" runat="server" Text="Confirm Booking" CssClass="btn btn-success" />
                                    </div>
                                    <div class="col-sm-4 col-lg-4">
                                    </div>
                                </div>
