...
Partial Class BookingEasy_PopupUpdateBookingTable
    ...
    Protected Sub btnConfitmBooking_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnConfitmBooking.Click
        Try
            ...
            End If
            'Session("total_amt_new") = serviceTotal
            Dim roomId As String = "0"

            Dim bookingDate As DateTime = Convert.ToDateTime(ArrivalDate)

            objCommon.CreateBooking(2, Utils.ParseInt(NoOfCover), txtComment.Text, Utils.ParseInt(roomId), Utils.ParseDateTime(ArrivalDate), Nothing, 0, BookingRefNo, 0, Session("da_amount").ToString(),
