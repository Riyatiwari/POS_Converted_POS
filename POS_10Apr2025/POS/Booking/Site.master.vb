...
Partial Class BookingEasy_Site
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Sessions.TabID = 0 Or Sessions.TabID = Nothing Then
            If Sessions.UserID <> 0 Then
                aNavbarHome.HRef = "Dashboard.aspx?TabId=" + Utils.Encrypt("0") + ""
                aMenuHome.HRef = "Dashboard.aspx?TabId=" + Utils.Encrypt("0") + ""
            Else
            ...
            End If
        Else
            aNavbarHome.HRef = "Dashboard.aspx?TabId=" + Utils.Encrypt(Sessions.TabID) + ""
            aMenuHome.HRef = "Dashboard.aspx?TabId=" + Utils.Encrypt(Sessions.TabID) + ""
        End If
