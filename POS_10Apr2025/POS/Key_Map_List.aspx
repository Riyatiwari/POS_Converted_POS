<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Key_Map_List.aspx.vb" Inherits="Key_Map_List" %>
 ...
 <asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolderLink" runat="Server">
    <div class="page-header pull-left">
        <ol class="breadcrumb page-breadcrumb pull-left">
            ...
            <li class="active">Key Map List</li>
        </ol>
    </div>
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-yellow">
            <div class="panel-heading">Key Map List</div>
            <div class="panel-body pan">
                <div class="form-body pal">
                    <div class="row">
                        <div class="col-lg-12 ">
                            <asp:LinkButton ID="lnkNew" runat="server" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;New Key Map</asp:LinkButton>&nbsp;&nbsp;
                                 <asp:LinkButton ID="lnkCopy" runat="server" class="btn btn-primary"><i class="fa fa-forward"></i>&nbsp;Copy</asp:LinkButton>
                             &nbsp;<asp:LinkButton ID="lnkSyncallTill" runat="server" OnClick="lnkSyncallTill_Click" class="btn btn-primary" ><i class="fa fa-sync"></i>&nbsp;Sync to all Tills</asp:LinkButton>
                        ...
                        <div class="col-lg-12 ">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="Lsummary" width="100%" cellspacing="0">
                                    <asp:Repeater ID="rdKayMap" runat="server" OnItemCommand="rdKayMap_ItemCommand">
                                        <HeaderTemplate>
                                            <thead>
                                                <tr>
                                                    <th></th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="background-color: #ffffff; text-align: center;">
                                                    <asp:HiddenField ID="hd_KeyMap" runat="server" Value='<%#Eval("key_map_id")%>' />
                                                    <asp:CheckBox ID="chk_KeyMap" runat="server" />
                                                </td>
                                                <td style="background-color: #ffffff;">
                                                    <asp:LinkButton ID="lbtnKeyMapEdit" runat="server" CausesValidation="False" PostBackUrl='<%#"KeyMap_Master.aspx?key_map_id=" & Eval("key_map_id") %>'
                                                        CommandName="KeyMapEdit" OnClientClick="return true;"><%#Eval("name") %></asp:LinkButton>
                                                </td>
                                                <td style="background-color: #ffffff;"><%#Eval("description")%></td>
                                                <td style="background-color: #ffffff;"><%#Eval("shorting_no")%></td>
                                                <td style="background-color: #ffffff;"><%#Eval("Active")%></td>

                                                <td style="background-color: #ffffff;">
                                                    <asp:HiddenField ID="hdkey_map_id" runat="server" Value='<%#Eval("key_map_id")%>' />
                                                    <asp:LinkButton ID="IbEdit" runat="server" CausesValidation="False" ToolTip="Edit"
                                                        CommandArgument='<%#Eval("key_map_id")%>' CommandName="Edit" OnClientClick="return true;"><i class="fa fa-edit fa-lg"></i></asp:LinkButton>
                                                    &nbsp;&nbsp;&nbsp;
                                        <asp:LinkButton ID="IbDelete" runat="server" CausesValidation="False" ToolTip="Delete"
                                            CommandArgument='<%#Eval("key_map_id")%>' CommandName="Delete" OnClientClick="return confirm('Are you sure you want to delete this record ?');">
                            ...
                            <tfoot>
                                ...
                                <%--<telerik:RadGrid ID="rdKayMap" AutoGenerateColumns="false" AllowPaging="True" AllowSorting="True" runat="server" ShowGroupPanel="False"
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" DataKeyNames="key_map_id" AllowMultiColumnSorting="true">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn ShowFilterIcon="false" CurrentFilterFunction="StartsWith" AutoPostBackOnFilter="true" HeaderText="Sorting No"
                                                SortExpression="shorting_no" DataField="shorting_no" DataType="System.String">
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Action" UniqueName="TemplateColumn" AllowFiltering="false">
                                                <ItemTemplate>
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <asp:LinkButton ID="IbDelete" runat="server" CausesValidation="False" ToolTip="Delete"
                                            CommandArgument='<%#Eval("key_map_id")%>' CommandName="Delete" OnClientClick="return confirm('Are you sure you want to delete this record ?');"><i class="fa fa-minus-square-o fa-lg"></i></asp:LinkButton>
                                                </ItemTemplate>
