<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Cloud_Net.aspx.vb" Inherits="Cloud_Net" %>
    ...
    <div class="col-lg-12 ">
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            <div class="panel panel-yellow" runat="server" id="divCompany">
                <div class="panel-heading">Cloud Net</div>
                <div class="panel-body pan">

                    <div class="form-body pal">
                        <div class="row">
                            <asp:Label style="float:right; margin-right:20px"><i class="fa fa-angle-right" ></i>&nbsp;<a href="Transfered_Data.aspx">Show All Transfered Data</a></asp:Label>
