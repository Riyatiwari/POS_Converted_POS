<%@ WebHandler Language="VB" Class="KioskImageHandler" %>
...
Public Class KioskImageHandler : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                If Val(context.Request.QueryString("TillID").ToString()) > 0 Then

                    oColSqlPar.Add("@TillID", context.Request.QueryString("TillID"))

                    imgdt = GetdataTableSp("WS_Get_Kiosk_Image", oColSqlPar, "WS_Get_Kiosk_Image", getconstr(dt))

                End If


                If imgdt.Rows.Count > 0 Then
                    context.Response.BinaryWrite(DirectCast(imgdt.Rows(0)("BG_Image"), Byte()))
