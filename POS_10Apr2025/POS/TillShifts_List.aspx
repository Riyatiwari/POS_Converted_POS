<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="TillShifts_List.aspx.vb" Inherits="TillShifts_List" %>
 ...
 <asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolderLink" runat="Server">
    <div class="page-header pull-left">
        <ol class="breadcrumb page-breadcrumb pull-left">
            ...
            <li class="active">Till Shifts</li>
        </ol>
    </div>
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-lg-12">
        <div class="panel panel-yellow">
            <div class="panel-heading">Till Shifts  List</div>
            <div class="panel-body pan">
                <div class="form-body pal">
                    <div class="row">
                        <div class="col-lg-12 ">
                            <asp:LinkButton ID="lnkNew" runat="server" OnClick="lnkNew_Click" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;New Till Shifts </asp:LinkButton>
                            <asp:Button ID="btnCreateShifts" OnClientClick="return confirm('Are you sure you want Create default shifts ?');" class="btn btn-green" runat="server" OnClick="btnCreateShift_Click" Text="Create Default Shift" ToolTip="Click here to Create default shifts" />
                        </div>
                    </div>
                    <br />
                            ...
                            <div class="col-lg-12 ">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="Lsummary" width="100%" cellspacing="0">
                                        <asp:Repeater ID="rdtill" runat="server">
                                            <HeaderTemplate>
                                                <thead>
                                                    <tr>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td style="background-color: #ffffff;"><%#Eval("shift_name")%></td>
                                                    <td style="background-color: #ffffff;"><%#Eval("shift_no")%></td>
                                                    <td style="background-color: #ffffff;"><%#Eval("name")%></td>
                                                    <td style="background-color: #ffffff;"><%#Eval("active")%></td>
                                                    <td style="background-color: #ffffff;">
                                                        <asp:HiddenField ID="hfdn_id" runat="server" Value='<%#Eval("tillshift_id")%>' />
                                                        <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" ToolTip="Edit"
                                                            CommandArgument='<%#Eval("tillshift_id")%>' CommandName="Edit" OnClientClick="return true;"><i class="fa fa-edit fa-lg"></i></asp:LinkButton>

                                                        &nbsp;&nbsp;&nbsp;<asp:LinkButton ID="IbDelete" runat="server" CausesValidation="False" ToolTip="Delete"
                                                            CommandArgument='<%#Eval("tillshift_id")%>' CommandName="Delete" OnClientClick="return confirm('Are you sure you want to Delete this Record ?');">
