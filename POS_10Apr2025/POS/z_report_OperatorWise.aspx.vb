...
Partial Class z_report_OperatorWise
    Inherits BaseClass
    ...
    Private Sub BindTable()
        Try
            ...
            dt = oClsDal.GetdataTableSp("WS_Get_Z_Report_OperatorWise", oColSqlparram)
        ...
        Catch ex As Exception
            LogHelper.Error("z_report_OperatorWise:BindTable:" + ex.Message)
        End Try
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            ...
            End If
        Catch ex As Exception
            LogHelper.Error("z_report_OperatorWise:Page_Load:" + ex.Message)
        End Try
    ...
    Protected Sub RoleCheck()
        Try
            ...
            oclsRole.Form_Name = "Z Report Operator Wise"
            oclsRole.Select()
        ...
        Catch ex As Exception
            LogHelper.Error("z_report_OperatorWise:RoleCheck:" + ex.Message)
        End Try
    End Sub
    ...
    Protected Sub LinkButton1_Click(sender As Object, e As EventArgs) Handles LinkButton1.Click
        Try
            BindTable()
        Catch ex As Exception
            LogHelper.Error("z_report_OperatorWise:LinkButton1_Click:" + ex.Message)
        End Try
    End Sub
    ...
    Public Sub binddll()
        ...
        Catch ex As Exception
            ...
            LogHelper.Error("z_report_OperatorWise:binddll:" + ex.Message)
        End Try
    End Sub
    ...
    Protected Sub radVenue_SelectedIndexChanged(sender As Object, e As RadComboBoxSelectedIndexChangedEventArgs) Handles radVenue.SelectedIndexChanged
        ...
        Catch ex As Exception
            LogHelper.Error("z_report_OperatorWise:radVenue_SelectedIndexChanged:" + ex.Message)
        End Try
    End Sub
    ...
    Protected Sub radLocation_SelectedIndexChanged(sender As Object, e As RadComboBoxSelectedIndexChangedEventArgs) Handles radLocation.SelectedIndexChanged
        Try
            ...
            End If
        Catch ex As Exception
            LogHelper.Error("z_report_OperatorWise:radLocation_SelectedIndexChanged:" + ex.Message)
        End Try
    End Sub
    ...
    Protected Sub radDuration_SelectedIndexChanged(sender As Object, e As RadComboBoxSelectedIndexChangedEventArgs) Handles radDuration.SelectedIndexChanged
        Try
            ...
            End If
        Catch ex As Exception
            LogHelper.Error("z_report_OperatorWise:radDuration_SelectedIndexChanged:" + ex.Message)
        End Try
    End Sub
            ...
            If txtemail.Text IsNot "" Then
                If Not HtmlReport() = "" Then
                    ...
                    With message
                        ...
                        .Subject = "Z Report Operator Wise"
                        .From = fromAdd
                        .IsBodyHtml = True
    ...
    Public Function HtmlReport() As String
        ...
        If Not ViewState("emaildata") Is Nothing Then
            ...
            srtbhtmlreport.Append("<tr align='center'>" +
                              "<td align='center' colspan='8' style='font-size:larger'>Z Report Operator Wise</td>" +
                               "</tr>")
