...
Partial Class BarStockExchange_Scheduler
    Inherits BaseClass
                ...
                If dt2.Rows.Count > 0 Then
                    For Each row2 As DataRow In dt2.Rows
                        ...
                        If Not String.IsNullOrEmpty(ViewState("machine_id")) Then
                            ...
                            LogHelper.Error("Scheduler:SalesID: " & ViewState("salesID"))
                            LogHelper.Error("Scheduler: Url: " & url)
                            LogHelper.Error("Scheduler: Header: mangle-cloud-api-key: " & value)
                            LogHelper.Error("Scheduler: Body: " & data)
                            LogHelper.Error("Scheduler: Start request")
                            ...
                            LogHelper.Error("Scheduler:Location ID: " & oclsLocation.location_id & ", Machine ID: " & ViewState("machine_id") & ", T-Sales ID: " & ViewState("salesID") & ", cassette: " & cassette & ", Quantity: " & reading)
                            ...
                            LogHelper.Error("Scheduler:End request")

                            Dim statusCode As Integer = CType(response, HttpWebResponse).StatusCode
                            LogHelper.Error("Scheduler: Response Code: " & statusCode)
                            ...
                            Using dataStream As Stream = response.GetResponseStream()
                                ...
                                LogHelper.Error("Scheduler:Response Code: " & responseFromServer)
