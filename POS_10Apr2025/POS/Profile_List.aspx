<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="Profile_List.aspx.vb" Inherits="Profile_List" %>
        ...
        <div class="panel panel-yellow">
            ...
            <div class="panel-body pan">
                <div class="form-body pal">
                    <div class="row">
                        <div class="col-lg-12 ">
                            <asp:LinkButton ID="lnkNew" runat="server" class="btn btn-primary" OnClick="lnkNew_Click"><i class="fa fa-plus"></i>&nbsp;New Profile</asp:LinkButton>
                        </div>
                    </div>
                    <br />
                            ...
                            <div class="col-lg-12 ">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="Lsummary" width="100%" cellspacing="0">
                                        <asp:Repeater ID="rdprofile" runat="server">
                                            <HeaderTemplate>
                                                <thead>
                                                    <tr>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="background-color: #ffffff;"><%#Eval("profile_name")%></td>

                                                    <td style="background-color: #ffffff;">
                                                        <asp:HiddenField ID="hfdn_id" runat="server" Value='<%#Eval("profile_id")%>' />
                                                        <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" ToolTip="Edit"
                                                            CommandArgument='<%#Eval("profile_id")%>' CommandName="Edit" OnClientClick="return true;"><i class="fa fa-edit fa-lg"></i></asp:LinkButton>

                                                        &nbsp;&nbsp;<asp:LinkButton ID="IbDelete" runat="server" CausesValidation="False" ToolTip="Delete"
                                                            CommandArgument='<%#Eval("profile_id")%>' CommandName="Delete" OnClientClick="return confirm('Are you sure you want to Delete this Record ?');">
