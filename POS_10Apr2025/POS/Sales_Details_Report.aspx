<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Sales_Details_Report.aspx.vb" Inherits="Sales_Details_Report" %>
    ...
    <div class="col-lg-12" id="divFunction" runat="server">
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" >
            ...
            <div class="panel panel-yellow">
                <div class="panel-heading">Sales Details Report</div>
                             ...
                             <div class="col-lg-6 ">                                     
                              ...
                              <div class="col-lg-12 " >
                                 <telerik:ReportViewer ID="ReportViewer1" runat="server" Style="border: 1px solid #ccc;"
                                                Width="70%" Height="550px" Visible="false" />
                                    </div>
