<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="z_report_OperatorWise.aspx.vb" Inherits="z_report_OperatorWise" %>

 <asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    Z Report Operator Wise
</asp:Content>
 <asp:Content ID="Content2" ContentPlaceHolderID="PlaceHolderLink" Runat="Server">
     <div class="page-header pull-left">
        <ol class="breadcrumb page-breadcrumb pull-left">
            ...
            <li class="active">Z Report Operator Wise</li>
        </ol>
    </div>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function disp_alert() {
            ...
            //main0 = 'Duration :' + Duration0 + "\n" + 'Venue :' + Venue0 + "\n" + 'Location :' + Location0 + "\n" + 'Till :' + Till0 + "\n" + 'Sales Type :' + salesType0 + "\n" + 'Shift Type :' + radshifttype0 + "\n" + 'Email :' + txtemail0 + "\n" + 'For Date :' + txtForDate0 + "\n" + 'To Date :' + txtToDate0
            //alert(main0)
        }
        ...
        function Grid() {
            ...
            //$('#Psummary').prepend('<tr style="display:none"><td> Email :</td><td>  ' + txtemail0 + '</td></tr>');
            ...
            var table = $('#Psummary').DataTable({
                ...
                buttons: [
                    {
                        ...
                        //    }
                        //},
                        //title: 'From Date : ' + vallblfromdate + 'TEST'
                        //messageTop: 'The information in this table is copyright to Sirius Cybernetics Corp.',                        

                        title: 'Z Report Operator Wise'
                    }
                ],
                ...
                //        if (last !== group) {
                //            $(rows).eq(i).before(
                //                //'<tr class="group"><td colspan="2"> Product Group : ' + group + '</td> </tr>'
                //            );
                //            last = group;
                //        }
                //    });
 ...
 <asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="col-lg-12" id="divFunction" runat="server">
        <div class="panel panel-yellow" id="dinction" runat="server">
            <div class="panel-heading">Z Report Operator Wise</div>
                ...
                <div class="form-body pal">
                        ...
                        <center>
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtEmail"
                              ...
                              <br /><br />
                                ...
                                <div class="col-lg-12 ">
                                    <table>
                                       <tr><h1 style="color:black">Z Report Operator Wise</h1><br /></tr> 
                    ...
                    <div class="table-responsive" >
                        <table class="table table-bordered"  id="Psummary" cellspacing="0">
                            <%--<tr><td> Duration :  </td><td>  test</td></tr>--%>
    ...
    <%--  <div class="col-lg-12 "> 
  <asp:Button ID="btnpdf" runat="server" class="btn btn-primary" ToolTip="View Report" Text="Export to Pdf" ></asp:Button>--%>
