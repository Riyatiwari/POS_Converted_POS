<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Product_Group_Master.aspx.vb" Inherits="Product_Group_Master" %>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <asp:DropDownList ID="ddlMainCategory" runat="server" Width="50%">
                                    </asp:DropDownList>
                                </div>
                                ...
                                <div class="col-md-12" runat="server" visible="false">
                                    ...
                                    <div class="clearfix"></div>
                                    <asp:DropDownList ID="ddKeyMap" runat="server" Width="50%">
                                    </asp:DropDownList>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="clearfix"></div>
                                    <asp:TextBox ID="txtsortingno" CssClass="form-control" Skin="" runat="server" placeholder="Sorting No" Width="80%"></asp:TextBox>
                                ...
                                <div class="col-md-6" style="display: none;">
                                    <label>
                                        Available on web order&nbsp;
                                            <asp:CheckBox ID="chkwebo" runat="server" Checked="true" /></label>
                                </div>
                                <div class="clearfix"></div>
                                <br />
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="rdMachineDetail" AutoGenerateColumns="false" AllowPaging="false" AllowSorting="True" runat="server" ShowGroupPanel="False"
                                            ...
                                            OnRowDataBound="rdMachineDetail_RowDataBound">

                                            <Columns>
                                                <asp:TemplateField HeaderText="Till">
                                                    <HeaderStyle Width="30%" HorizontalAlign="Center" />
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chk_Machine" runat="server" Value='<%# Eval("machine_id")%>' />
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12" style="margin-top: 10px;">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ValidationExpression="([a-zA-Z0-9\s_\\.\-:])+(.jpg|.jpeg|.gif|.png)$"
                                            ControlToValidate="fileupload" runat="server" ForeColor="Red" ErrorMessage="Please select a valid file with jpg, jpeg, png, gif extensions."
                                            Display="Dynamic" />
                                        <div class="clearfix"></div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-6" style="overflow-x: auto; overflow-y: auto; width: 100%; height: 100px;">
                                    <asp:CheckBoxList ID="chklocation" Visible="false" Style="margin-right: 5px;" runat="server" EnableCheckAllItemsCheckBox="True" class="mycheckbox" CheckBoxes="True" Width="100%"
