<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Export_Sales_Report.aspx.vb" Inherits="Export_Sales_Report" %>
 ...
 <asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolderLink" runat="Server">
    ...
    <div class="page-header pull-left">
        <ol class="breadcrumb page-breadcrumb pull-left">
            ...
            <li class="active">Export Sales Report</li>
        </ol>
    </div>
</asp:Content>
    ...
    <div class="col-lg-12" id="divFunction" runat="server">
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            ...
            <div class="panel panel-yellow">
                <div class="panel-heading">Export Sales Report</div>
                             ...
                             <div class="col-lg-6 ">                                     
                              ...
                              <div class="col-lg-12 " >
                                 <telerik:ReportViewer ID="ReportViewer1" runat="server" Style="border: 1px solid #ccc;"
                                                Width="67%" Height="550px" Visible="false" />
                                    </div>
