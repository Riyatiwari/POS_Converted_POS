    ...
    Private Sub form1_Load(sender As Object, e As EventArgs) Handles form1.Load
        ...
        Try
            ...
            If Session("source_type").ToString() = "1" Then
                Response.Redirect("https://live.mytenderpos.com/CF_success.aspx?paymentjobref=" + Request.QueryString("paymentjobref").ToString() + "&paymentref=" + Request.QueryString("paymentref").ToString())
            Else
                Response.Redirect("https://live.mytenderpos.com/wpos/CF_success.aspx?paymentjobref=" + Request.QueryString("paymentjobref").ToString() + "&paymentref=" + Request.QueryString("paymentref").ToString())
            End If
