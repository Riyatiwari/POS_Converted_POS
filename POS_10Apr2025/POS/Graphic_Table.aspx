<%@ Page Title="" Language="VB" AutoEventWireup="false" CodeFile="Graphic_Table.aspx.vb"
    Inherits="Graphic_Table" EnableEventValidation="false" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
            ...
            <div id="header-topbar-option-demo" class="page-header-topbar">
                <nav id="topbar" role="navigation" style="margin-bottom: 0; z-index: 2;"
                    ...
                    <div id="dvMain" class="topbar-main">
            ...
            <div style="width: 100%;">
                <div style="float: right; width: 84.8%;">
                    <div class="row" style="margin-bottom: 5px; height: 33px;">
                        <telerik:RadAjaxPanel ID="RadAjaxPanel3" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
                            <asp:ImageButton ID="imgrefreshTableView" runat="server" Width="25px" Height="25px" Style="padding: 5px; float: right;" ToolTip="Refresh Table View"
                            ...
                            <asp:Button ID="lnkExport" Text="Export as Image" runat="server" UseSubmitBehavior="false"
                                ValidationGroup="RFShape" OnClick="lnkExport_Click" OnClientClick="return ConvertPageToImage(this)"
                        ...
                        Location:</label>
                    <telerik:RadDropDownList ID="ddlVenue1" Skin="MetroTouch" runat="server" Width="200px"
                        AutoPostBack="true" DropDownHeight="200px" Style="color: #393939 !important;
                        font-family: 'Open Sans' !important; font-size: 15px !Important;">
                    </telerik:RadDropDownList>
                    <label style="margin-left: 10px;">
                        Schedule:</label>
                    <telerik:RadDropDownList ID="ddlType1" Skin="MetroTouch" runat="server" Width="120px"
                        DropDownHeight="120px" AutoPostBack="True">
                    </telerik:RadDropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlType1"
                        ForeColor="Red" ErrorMessage="Select Schedule" Display="Dynamic" ValidationGroup="Search">
                            ...
                            <div class="divmargin">
                                ...
                                <%--<div style="padding-left: 10px;">
                                    ...
                                    <div class="divmargin2">
                                        <div style="height: 20px; width: 20%; background-color: #6EDA6E; text-align: center;
                                            float: left;">
                                        </div>
                                    ...
                                    <div class="divmargin2">
                                        <div style="height: 20px; width: 20%; background-color: #5FA2D7; text-align: center;
                                            float: left;">
                                        </div>
                                        <div style="width: 80%; float: right;">
                                            &nbsp;Seated</div>
                                    ...
                                    <div class="divmargin2">
                                        <div style="height: 20px; width: 20%; background-color: #4040FF; text-align: center;
                                            float: left;">
                                        </div>
                                        <div style="width: 80%; float: right;">
                                            &nbsp;Booked</div>
            ...
            <div>
                <div style="float: left; width: 100%; margin-top: 10px; border-color: #6D7377; border-width: 1px; border-style: solid;">
                    <div style="width: 6%; float: left;">
                        <b style="margin: 5px;"><u>Legend:</u></b>
                    </div>
                        ...
                        <div style="display: block;">
                            <div style="display: table-cell; float: left;">
                                ...
                                <div style="display: table-cell; float: left; margin: 5px;">
                                    <asp:Label ID="Label23" runat="server" Text="Available"></asp:Label>
                                </div>
                                <div style="height: 20px; margin: 5px; width: 20px; float: left; background-color: #555e5e">
                                </div>
                                <div style="display: table-cell; float: left; margin: 5px;">
                                    <asp:Label ID="Label22" runat="server" Text="Booked"></asp:Label>
                                </div>
                                <div style="height: 20px; margin: 5px; width: 20px; float: left; background-color: #949e9e">
                                </div>
                                <div style="display: table-cell; float: left; margin: 5px;">
                                    <asp:Label ID="Label21" runat="server" Text="Seated"></asp:Label>
                                </div>
                            </div>
                        </div>
