...
namespace Converted_POS.Pages
{
    public class Login : PageModel
    {
        ...
        [BindProperty]
        public clsLogin clsLogin { get; set; }
        ...
        public ActionResult OnPost()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("Get_DB_Connection_Details", con);
                cmd.CommandType = CommandType.StoredProcedure;

                cmd.Parameters.AddWithValue("@db_name", clsLogin.StoreName);
            ...
            {
                SqlCommand cmd = new SqlCommand("do_Login", con1);
                cmd.CommandType = CommandType.StoredProcedure;

                cmd.Parameters.AddWithValue("@Username", clsLogin.UserName);
                cmd.Parameters.AddWithValue("@Password", Encrypt(clsLogin.Password));
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    HttpContext.Session.SetString("store", clsLogin.StoreName);
