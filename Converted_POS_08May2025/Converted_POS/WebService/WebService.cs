...
namespace Converted_POS.WebService
{
    public class WebService : Controller
    {
        ...
        private readonly WSController obj;
        public WebService(IConfiguration configuration)
        {
            _configuration = configuration;
            obj = new WSController(_configuration);
        }
        ...
        {
            if (str == "[]" || str == "No User Found." || str == "Invalid Webservice User Access...!")
            {
        ...
        public DataTable getStore(string storeName)
        {
            try
            {
                SqlConnection con = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["POSControllerConnectionString"].ConnectionString);
